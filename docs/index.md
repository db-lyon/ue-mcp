...
**Unreal Engine Model Context Protocol Server** - lets AI assistants drive the Unreal Editor through <!-- count:tools -->23<!-- /count --> category tools covering <!-- count:actions -->677+<!-- /count --> actions.
...
- **[Tool Reference](tool-reference.md)** - All <!-- count:tools -->23<!-- /count --> tools with every action and its parameters
