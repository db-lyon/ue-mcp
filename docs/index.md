...
**Unreal Engine Model Context Protocol Server** - lets AI assistants drive the Unreal Editor through <!-- count:tools -->22<!-- /count --> category tools covering <!-- count:actions -->612+<!-- /count --> actions.
...
- **[Tool Reference](tool-reference.md)** - All <!-- count:tools -->22<!-- /count --> tools with every action and its parameters
