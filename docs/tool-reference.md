...
| `capture_screenshot` | Screenshot. Params: `filename?, resolution?, target? (auto\\|pie\\|editor; auto reads the live PIE game viewport when PIE is running; PNG writes are synchronous) (#226/#575)` |
