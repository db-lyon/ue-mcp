export const SERVER_INSTRUCTIONS = `UE-MCP: Unreal Engine editor bridge with 185+ tools. All tools require a live editor connection via the Python bridge.

Call get_status first to check whether the editor is connected.

═══ TOOL DIRECTORY ═══

ASSET MANAGEMENT:
  Read: read_asset, read_asset_properties, list_assets, search_assets
...
WIDGETS / UMG:
  ...
  Edit: set_widget_property

EDITOR UTILITIES (custom editor tools):
  Create: create_editor_utility_widget, create_editor_utility_blueprint
  Run: run_editor_utility_widget, run_editor_utility_blueprint
