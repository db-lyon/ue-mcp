...
export const actions: Record<string, ActionSpec> = {
  epic_add_emitter: { epicSchema: S_epic_add_emitter, ...bp(
    "mutate",
  ...
  epic_add_module: { epicSchema: S_epic_add_module, ...bp(
    "mutate",
  ...
  epic_add_renderer: { epicSchema: S_epic_add_renderer, ...bp(
    "mutate",
  ...
  epic_add_set_parameter_entry: { epicSchema: S_epic_add_set_parameter_entry, ...bp(
    "mutate",
  ...
  epic_add_set_parameters_module: { epicSchema: S_epic_add_set_parameters_module, ...bp(
    "mutate",
  ...
  epic_add_user_variables: { epicSchema: S_epic_add_user_variables, ...bp(
    "mutate",
  ...
  epic_apply_stack_issue_fix: { epicSchema: S_epic_apply_stack_issue_fix, ...bp(
    "mutate",
  ...
  epic_construct_niagara_bpwrapper_from_component: { epicSchema: S_epic_construct_niagara_bpwrapper_from_component, ...bp(
    "mutate",
  ...
  epic_construct_niagara_bpwrapper_from_system: { epicSchema: S_epic_construct_niagara_bpwrapper_from_system, ...bp(
    "mutate",
  ...
  epic_create_niagara_system: { epicSchema: S_epic_create_niagara_system, ...bp(
    "mutate",
  ...
  epic_find_niagara_scripts: { epicSchema: S_epic_find_niagara_scripts, ...bp(
    "read",
  ...
  epic_get_asset_discovery_info: { epicSchema: S_epic_get_asset_discovery_info, ...bp(
    "read",
  ...
  epic_get_available_dynamic_inputs: { epicSchema: S_epic_get_available_dynamic_inputs, ...bp(
    "read",
  ...
  epic_get_data_interface_schema: { epicSchema: S_epic_get_data_interface_schema, ...bp(
    "read",
  ...
  epic_get_dynamic_input_chain: { epicSchema: S_epic_get_dynamic_input_chain, ...bp(
    "read",
  ...
  epic_get_dynamic_input_schema: { epicSchema: S_epic_get_dynamic_input_schema, ...bp(
    "read",
  ...
  epic_get_dynamic_input_schema_from_asset: { epicSchema: S_epic_get_dynamic_input_schema_from_asset, ...bp(
    "read",
  ...
  epic_get_emitter_data: { epicSchema: S_epic_get_emitter_data, ...bp(
    "read",
  ...
  epic_get_emitter_input_values: { epicSchema: S_epic_get_emitter_input_values, ...bp(
    "read",
  ...
  epic_get_emitter_schema: { epicSchema: S_epic_get_emitter_schema, ...bp(
    "read",
  ...
  epic_get_emitter_summary: { epicSchema: S_epic_get_emitter_summary, ...bp(
    "read",
  ...
  epic_get_emitter_topology: { epicSchema: S_epic_get_emitter_topology, ...bp(
    "read",
  ...
  epic_get_module_input_values: { epicSchema: S_epic_get_module_input_values, ...bp(
    "read",
  ...
  epic_get_module_schema: { epicSchema: S_epic_get_module_schema, ...bp(
    "read",
  ...
  epic_get_module_schema_from_asset: { epicSchema: S_epic_get_module_schema_from_asset, ...bp(
    "read",
  ...
  epic_get_module_topology: { epicSchema: S_epic_get_module_topology, ...bp(
    "read",
  ...
  epic_get_niagara_script_digest: { epicSchema: S_epic_get_niagara_script_digest, ...bp(
    "read",
  ...
  epic_get_renderer_data: { epicSchema: S_epic_get_renderer_data, ...bp(
    "read",
  ...
  epic_get_renderer_schema: { epicSchema: S_epic_get_renderer_schema, ...bp(
    "read",
  ...
  epic_get_script_stack_input_values: { epicSchema: S_epic_get_script_stack_input_values, ...bp(
    "read",
  ...
  epic_get_script_stack_topology: { epicSchema: S_epic_get_script_stack_topology, ...bp(
    "read",
  ...
  epic_get_stack_input_data: { epicSchema: S_epic_get_stack_input_data, ...bp(
    "read",
  ...
  epic_get_stack_input_schema: { epicSchema: S_epic_get_stack_input_schema, ...bp(
    "read",
  ...
  epic_get_stack_input_topology: { epicSchema: S_epic_get_stack_input_topology, ...bp(
    "read",
  ...
  epic_get_stack_issues: { epicSchema: S_epic_get_stack_issues, ...bp(
    "read",
  ...
  epic_get_system_compile_state: { epicSchema: S_epic_get_system_compile_state, ...bp(
    "read",
  ...
  epic_get_system_data: { epicSchema: S_epic_get_system_data, ...bp(
    "read",
  ...
  epic_get_system_dependencies: { epicSchema: S_epic_get_system_dependencies, ...bp(
    "read",
  ...
  epic_get_system_schema: { epicSchema: S_epic_get_system_schema, ...bp(
    "read",
  ...
  epic_get_system_summary: { epicSchema: S_epic_get_system_summary, ...bp(
    "read",
  ...
  epic_get_user_variables: { epicSchema: S_epic_get_user_variables, ...bp(
    "read",
  ...
  epic_get_user_variables__niagara_toolset_system: { epicSchema: S_epic_get_user_variables__niagara_toolset_system, ...bp(
    "read",
  ...
  epic_remove_emitter: { epicSchema: S_epic_remove_emitter, ...bp(
    "mutate",
  ...
  epic_remove_module: { epicSchema: S_epic_remove_module, ...bp(
    "mutate",
  ...
  epic_remove_renderer: { epicSchema: S_epic_remove_renderer, ...bp(
    "mutate",
  ...
  epic_remove_set_parameter_entry: { epicSchema: S_epic_remove_set_parameter_entry, ...bp(
    "mutate",
  ...
  epic_remove_user_variables: { epicSchema: S_epic_remove_user_variables, ...bp(
    "mutate",
  ...
  epic_set_emitter_data: { epicSchema: S_epic_set_emitter_data, ...bp(
    "mutate",
  ...
  epic_set_module_enabled: { epicSchema: S_epic_set_module_enabled, ...bp(
    "mutate",
  ...
  epic_set_renderer_data: { epicSchema: S_epic_set_renderer_data, ...bp(
    "mutate",
  ...
  epic_set_stack_input_data: { epicSchema: S_epic_set_stack_input_data, ...bp(
    "mutate",
  ...
  epic_set_system: { epicSchema: S_epic_set_system, ...bp(
    "mutate",
  ...
  epic_set_system_data: { epicSchema: S_epic_set_system_data, ...bp(
    "mutate",
  ...
  epic_uenum_info: { epicSchema: S_epic_uenum_info, ...bp(
    "read",
