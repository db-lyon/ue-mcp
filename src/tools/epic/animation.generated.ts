...
export const actions: Record<string, ActionSpec> = {
  epic_add_actors: { epicSchema: S_epic_add_actors, ...bp(
    "mutate",
  ...
  epic_add_actors_by_name: { epicSchema: S_epic_add_actors_by_name, ...bp(
    "mutate",
  ...
  epic_add_actors_to_binding: { epicSchema: S_epic_add_actors_to_binding, ...bp(
    "mutate",
  ...
  epic_add_backward_solve_graph: { epicSchema: S_epic_add_backward_solve_graph, ...bp(
    "mutate",
  ...
  epic_add_binding_to_folder: { epicSchema: S_epic_add_binding_to_folder, ...bp(
    "mutate",
  ...
  epic_add_bone: { epicSchema: S_epic_add_bone, ...bp(
    "mutate",
  ...
  epic_add_control: { epicSchema: S_epic_add_control, ...bp(
    "mutate",
  ...
  epic_add_element: { epicSchema: S_epic_add_element, ...bp(
    "mutate",
  ...
  epic_add_event_graph: { epicSchema: S_epic_add_event_graph, ...bp(
    "mutate",
  ...
  epic_add_event_node: { epicSchema: S_epic_add_event_node, ...bp(
    "mutate",
  ...
  epic_add_event_repeater_section: { epicSchema: S_epic_add_event_repeater_section, ...bp(
    "mutate",
  ...
  epic_add_event_trigger_section: { epicSchema: S_epic_add_event_trigger_section, ...bp(
    "mutate",
  ...
  epic_add_graph: { epicSchema: S_epic_add_graph, ...bp(
    "mutate",
  ...
  epic_add_interaction_graph: { epicSchema: S_epic_add_interaction_graph, ...bp(
    "mutate",
  ...
  epic_add_key_bool: { epicSchema: S_epic_add_key_bool, ...bp(
    "mutate",
  ...
  epic_add_key_float: { epicSchema: S_epic_add_key_float, ...bp(
    "mutate",
  ...
  epic_add_key_integer: { epicSchema: S_epic_add_key_integer, ...bp(
    "mutate",
  ...
  epic_add_key_string: { epicSchema: S_epic_add_key_string, ...bp(
    "mutate",
  ...
  epic_add_layer_from_selection: { epicSchema: S_epic_add_layer_from_selection, ...bp(
    "mutate",
  ...
  epic_add_marked_frame: { epicSchema: S_epic_add_marked_frame, ...bp(
    "mutate",
  ...
  epic_add_null: { epicSchema: S_epic_add_null, ...bp(
    "mutate",
  ...
  epic_add_root_folder: { epicSchema: S_epic_add_root_folder, ...bp(
    "mutate",
  ...
  epic_add_section: { epicSchema: S_epic_add_section, ...bp(
    "mutate",
  ...
  epic_add_socket: { epicSchema: S_epic_add_socket, ...bp(
    "mutate",
  ...
  epic_add_spawnable_from_class: { epicSchema: S_epic_add_spawnable_from_class, ...bp(
    "mutate",
  ...
  epic_add_spawnable_from_instance: { epicSchema: S_epic_add_spawnable_from_instance, ...bp(
    "mutate",
  ...
  epic_add_track_to_binding: { epicSchema: S_epic_add_track_to_binding, ...bp(
    "mutate",
  ...
  epic_add_track_to_folder: { epicSchema: S_epic_add_track_to_folder, ...bp(
    "mutate",
  ...
  epic_add_track_to_sequence: { epicSchema: S_epic_add_track_to_sequence, ...bp(
    "mutate",
  ...
  epic_add_variable_node: { epicSchema: S_epic_add_variable_node, ...bp(
    "mutate",
  ...
  epic_assign_physics_asset: { epicSchema: S_epic_assign_physics_asset, ...bp(
    "mutate",
  ...
  epic_bake_channel_keys: { epicSchema: S_epic_bake_channel_keys, ...bp(
    "mutate",
  ...
  epic_bake_space: { epicSchema: S_epic_bake_space, ...bp(
    "mutate",
  ...
  epic_bake_to_control_rig: { epicSchema: S_epic_bake_to_control_rig, ...bp(
    "mutate",
  ...
  epic_bake_transform: { epicSchema: S_epic_bake_transform, ...bp(
    "mutate",
  ...
  epic_blend_values_on_selected: { epicSchema: S_epic_blend_values_on_selected, ...bp(
    "mutate",
  ...
  epic_change_actor_template_class: { epicSchema: S_epic_change_actor_template_class, ...bp(
    "mutate",
  ...
  epic_change_variable_type: { epicSchema: S_epic_change_variable_type, ...bp(
    "mutate",
  ...
  epic_clear_section_condition: { epicSchema: S_epic_clear_section_condition, ...bp(
    "mutate",
  ...
  epic_clear_selection: { epicSchema: S_epic_clear_selection, ...bp(
    "mutate",
  ...
  epic_clear_track_condition: { epicSchema: S_epic_clear_track_condition, ...bp(
    "mutate",
  ...
  epic_clear_track_row_condition: { epicSchema: S_epic_clear_track_row_condition, ...bp(
    "mutate",
  ...
  epic_close_curve_editor: { epicSchema: S_epic_close_curve_editor, ...bp(
    "mutate",
  ...
  epic_close_sequence: { epicSchema: S_epic_close_sequence, ...bp(
    "mutate",
  ...
  epic_collapse_anim_layers: { epicSchema: S_epic_collapse_anim_layers, ...bp(
    "mutate",
  ...
  epic_connect_pins: { epicSchema: S_epic_connect_pins, ...bp(
    "mutate",
  ...
  epic_convert_to_custom_binding: { epicSchema: S_epic_convert_to_custom_binding, ...bp(
    "mutate",
  ...
  epic_convert_to_possessable: { epicSchema: S_epic_convert_to_possessable, ...bp(
    "mutate",
  ...
  epic_convert_to_spawnable: { epicSchema: S_epic_convert_to_spawnable, ...bp(
    "mutate",
  ...
  epic_copy_bindings: { epicSchema: S_epic_copy_bindings, ...bp(
    "mutate",
  ...
  epic_copy_folders: { epicSchema: S_epic_copy_folders, ...bp(
    "mutate",
  ...
  epic_copy_sections: { epicSchema: S_epic_copy_sections, ...bp(
    "mutate",
  ...
  epic_copy_tracks: { epicSchema: S_epic_copy_tracks, ...bp(
    "mutate",
  ...
  epic_create_camera: { epicSchema: S_epic_create_camera, ...bp(
    "mutate",
  ...
  epic_create_level_sequence: { epicSchema: S_epic_create_level_sequence, ...bp(
    "mutate",
  ...
  epic_create_node: { epicSchema: S_epic_create_node, ...bp(
    "mutate",
  ...
  epic_curve_editor_empty_selection: { epicSchema: S_epic_curve_editor_empty_selection, ...bp(
    "mutate",
  ...
  epic_curve_editor_select_keys: { epicSchema: S_epic_curve_editor_select_keys, ...bp(
    "mutate",
  ...
  epic_delete_all_marked_frames: { epicSchema: S_epic_delete_all_marked_frames, ...bp(
    "mutate",
  ...
  epic_delete_anim_layer: { epicSchema: S_epic_delete_anim_layer, ...bp(
    "mutate",
  ...
  epic_delete_marked_frame: { epicSchema: S_epic_delete_marked_frame, ...bp(
    "mutate",
  ...
  epic_delete_node: { epicSchema: S_epic_delete_node, ...bp(
    "mutate",
  ...
  epic_delete_space: { epicSchema: S_epic_delete_space, ...bp(
    "mutate",
  ...
  epic_disconnect_pins: { epicSchema: S_epic_disconnect_pins, ...bp(
    "mutate",
  ...
  epic_duplicate_anim_layer: { epicSchema: S_epic_duplicate_anim_layer, ...bp(
    "mutate",
  ...
  epic_empty_selection: { epicSchema: S_epic_empty_selection, ...bp(
    "mutate",
  ...
  epic_export_anim_sequence: { epicSchema: S_epic_export_anim_sequence, ...bp(
    "mutate",
  ...
  epic_export_fbx: { epicSchema: S_epic_export_fbx, ...bp(
    "mutate",
  ...
  epic_export_fbx_from_rig: { epicSchema: S_epic_export_fbx_from_rig, ...bp(
    "mutate",
  ...
  epic_find_binding_by_name: { epicSchema: S_epic_find_binding_by_name, ...bp(
    "read",
  ...
  epic_find_binding_by_tag: { epicSchema: S_epic_find_binding_by_tag, ...bp(
    "read",
  ...
  epic_find_bindings_by_tag: { epicSchema: S_epic_find_bindings_by_tag, ...bp(
    "read",
  ...
  epic_find_marked_frame_by_label: { epicSchema: S_epic_find_marked_frame_by_label, ...bp(
    "read",
  ...
  epic_find_or_create_track: { epicSchema: S_epic_find_or_create_track, ...bp(
    "mutate",
  ...
  epic_find_tracks_by_type: { epicSchema: S_epic_find_tracks_by_type, ...bp(
    "read",
  ...
  epic_fix_actor_references: { epicSchema: S_epic_fix_actor_references, ...bp(
    "mutate",
  ...
  epic_focus_parent_sequence: { epicSchema: S_epic_focus_parent_sequence, ...bp(
    "mutate",
  ...
  epic_focus_sub_sequence: { epicSchema: S_epic_focus_sub_sequence, ...bp(
    "mutate",
  ...
  epic_force_evaluate: { epicSchema: S_epic_force_evaluate, ...bp(
    "mutate",
  ...
  epic_frame_selection: { epicSchema: S_epic_frame_selection, ...bp(
    "mutate",
  ...
  epic_get_actor_transform_at_frame: { epicSchema: S_epic_get_actor_transform_at_frame, ...bp(
    "read",
  ...
  epic_get_all_binding_tags: { epicSchema: S_epic_get_all_binding_tags, ...bp(
    "read",
  ...
  epic_get_all_bones: { epicSchema: S_epic_get_all_bones, ...bp(
    "read",
  ...
  epic_get_all_controls: { epicSchema: S_epic_get_all_controls, ...bp(
    "read",
  ...
  epic_get_all_nulls: { epicSchema: S_epic_get_all_nulls, ...bp(
    "read",
  ...
  epic_get_anim_layers: { epicSchema: S_epic_get_anim_layers, ...bp(
    "read",
  ...
  epic_get_anim_mode_gizmo_scale: { epicSchema: S_epic_get_anim_mode_gizmo_scale, ...bp(
    "read",
  ...
  epic_get_anim_mode_hide_manips: { epicSchema: S_epic_get_anim_mode_hide_manips, ...bp(
    "read",
  ...
  epic_get_anim_mode_hierarchy: { epicSchema: S_epic_get_anim_mode_hierarchy, ...bp(
    "read",
  ...
  epic_get_anim_mode_local_spaces: { epicSchema: S_epic_get_anim_mode_local_spaces, ...bp(
    "read",
  ...
  epic_get_anim_mode_nulls: { epicSchema: S_epic_get_anim_mode_nulls, ...bp(
    "read",
  ...
  epic_get_anim_mode_only_rig_sel: { epicSchema: S_epic_get_anim_mode_only_rig_sel, ...bp(
    "read",
  ...
  epic_get_backward_solve_graph: { epicSchema: S_epic_get_backward_solve_graph, ...bp(
    "read",
  ...
  epic_get_binding_id: { epicSchema: S_epic_get_binding_id, ...bp(
    "read",
  ...
  epic_get_binding_name: { epicSchema: S_epic_get_binding_name, ...bp(
    "read",
  ...
  epic_get_binding_tags: { epicSchema: S_epic_get_binding_tags, ...bp(
    "read",
  ...
  epic_get_bindings: { epicSchema: S_epic_get_bindings, ...bp(
    "read",
  ...
  epic_get_bone_children: { epicSchema: S_epic_get_bone_children, ...bp(
    "read",
  ...
  epic_get_bone_names: { epicSchema: S_epic_get_bone_names, ...bp(
    "read",
  ...
  epic_get_bone_parent: { epicSchema: S_epic_get_bone_parent, ...bp(
    "read",
  ...
  epic_get_bool: { epicSchema: S_epic_get_bool, ...bp(
    "read",
  ...
  epic_get_bound_objects: { epicSchema: S_epic_get_bound_objects, ...bp(
    "read",
  ...
  epic_get_channel_names: { epicSchema: S_epic_get_channel_names, ...bp(
    "read",
  ...
  epic_get_child_possessables: { epicSchema: S_epic_get_child_possessables, ...bp(
    "read",
  ...
  epic_get_clock_source: { epicSchema: S_epic_get_clock_source, ...bp(
    "read",
  ...
  epic_get_connected_pins: { epicSchema: S_epic_get_connected_pins, ...bp(
    "read",
  ...
  epic_get_control_rigs: { epicSchema: S_epic_get_control_rigs, ...bp(
    "read",
  ...
  epic_get_controls_info: { epicSchema: S_epic_get_controls_info, ...bp(
    "read",
  ...
  epic_get_controls_mask: { epicSchema: S_epic_get_controls_mask, ...bp(
    "read",
  ...
  epic_get_current_sequence: { epicSchema: S_epic_get_current_sequence, ...bp(
    "read",
  ...
  epic_get_curve_editor_selected_keys: { epicSchema: S_epic_get_curve_editor_selected_keys, ...bp(
    "read",
  ...
  epic_get_custom_binding_objects: { epicSchema: S_epic_get_custom_binding_objects, ...bp(
    "read",
  ...
  epic_get_custom_binding_type: { epicSchema: S_epic_get_custom_binding_type, ...bp(
    "read",
  ...
  epic_get_custom_bindings_of_type: { epicSchema: S_epic_get_custom_bindings_of_type, ...bp(
    "read",
  ...
  epic_get_deactivated_nodes: { epicSchema: S_epic_get_deactivated_nodes, ...bp(
    "read",
  ...
  epic_get_default_value: { epicSchema: S_epic_get_default_value, ...bp(
    "read",
  ...
  epic_get_display_rate: { epicSchema: S_epic_get_display_rate, ...bp(
    "read",
  ...
  epic_get_elements: { epicSchema: S_epic_get_elements, ...bp(
    "read",
  ...
  epic_get_euler_transform: { epicSchema: S_epic_get_euler_transform, ...bp(
    "read",
  ...
  epic_get_evaluation_type: { epicSchema: S_epic_get_evaluation_type, ...bp(
    "read",
  ...
  epic_get_event_graph: { epicSchema: S_epic_get_event_graph, ...bp(
    "read",
  ...
  epic_get_float: { epicSchema: S_epic_get_float, ...bp(
    "read",
  ...
  epic_get_focused_sequence: { epicSchema: S_epic_get_focused_sequence, ...bp(
    "read",
  ...
  epic_get_folder_contents: { epicSchema: S_epic_get_folder_contents, ...bp(
    "read",
  ...
  epic_get_forward_solve_graph: { epicSchema: S_epic_get_forward_solve_graph, ...bp(
    "read",
  ...
  epic_get_global_transform: { epicSchema: S_epic_get_global_transform, ...bp(
    "read",
  ...
  epic_get_graph: { epicSchema: S_epic_get_graph, ...bp(
    "read",
  ...
  epic_get_int: { epicSchema: S_epic_get_int, ...bp(
    "read",
  ...
  epic_get_interaction_graph: { epicSchema: S_epic_get_interaction_graph, ...bp(
    "read",
  ...
  epic_get_keys_by_index: { epicSchema: S_epic_get_keys_by_index, ...bp(
    "read",
  ...
  epic_get_linked_anim_sequences: { epicSchema: S_epic_get_linked_anim_sequences, ...bp(
    "read",
  ...
  epic_get_linked_level_sequence: { epicSchema: S_epic_get_linked_level_sequence, ...bp(
    "read",
  ...
  epic_get_local_transform: { epicSchema: S_epic_get_local_transform, ...bp(
    "read",
  ...
  epic_get_locked_nodes: { epicSchema: S_epic_get_locked_nodes, ...bp(
    "read",
  ...
  epic_get_loop_mode: { epicSchema: S_epic_get_loop_mode, ...bp(
    "read",
  ...
  epic_get_marked_frames: { epicSchema: S_epic_get_marked_frames, ...bp(
    "read",
  ...
  epic_get_morph_target_names: { epicSchema: S_epic_get_morph_target_names, ...bp(
    "read",
  ...
  epic_get_muted_nodes: { epicSchema: S_epic_get_muted_nodes, ...bp(
    "read",
  ...
  epic_get_node_label: { epicSchema: S_epic_get_node_label, ...bp(
    "read",
  ...
  epic_get_node_position: { epicSchema: S_epic_get_node_position, ...bp(
    "read",
  ...
  epic_get_outliner_children: { epicSchema: S_epic_get_outliner_children, ...bp(
    "read",
  ...
  epic_get_outliner_selection: { epicSchema: S_epic_get_outliner_selection, ...bp(
    "read",
  ...
  epic_get_outliner_tree: { epicSchema: S_epic_get_outliner_tree, ...bp(
    "read",
  ...
  epic_get_parent: { epicSchema: S_epic_get_parent, ...bp(
    "read",
  ...
  epic_get_physics_asset: { epicSchema: S_epic_get_physics_asset, ...bp(
    "read",
  ...
  epic_get_pin_value: { epicSchema: S_epic_get_pin_value, ...bp(
    "read",
  ...
  epic_get_pinned_nodes: { epicSchema: S_epic_get_pinned_nodes, ...bp(
    "read",
  ...
  epic_get_playback_range: { epicSchema: S_epic_get_playback_range, ...bp(
    "read",
  ...
  epic_get_playback_speed: { epicSchema: S_epic_get_playback_speed, ...bp(
    "read",
  ...
  epic_get_playhead_frame: { epicSchema: S_epic_get_playhead_frame, ...bp(
    "read",
  ...
  epic_get_position: { epicSchema: S_epic_get_position, ...bp(
    "read",
  ...
  epic_get_priority_order: { epicSchema: S_epic_get_priority_order, ...bp(
    "read",
  ...
  epic_get_root_folders: { epicSchema: S_epic_get_root_folders, ...bp(
    "read",
  ...
  epic_get_rotator: { epicSchema: S_epic_get_rotator, ...bp(
    "read",
  ...
  epic_get_scale: { epicSchema: S_epic_get_scale, ...bp(
    "read",
  ...
  epic_get_section_blend_type: { epicSchema: S_epic_get_section_blend_type, ...bp(
    "read",
  ...
  epic_get_section_completion_mode: { epicSchema: S_epic_get_section_completion_mode, ...bp(
    "read",
  ...
  epic_get_section_condition: { epicSchema: S_epic_get_section_condition, ...bp(
    "read",
  ...
  epic_get_section_count: { epicSchema: S_epic_get_section_count, ...bp(
    "read",
  ...
  epic_get_section_ease_in: { epicSchema: S_epic_get_section_ease_in, ...bp(
    "read",
  ...
  epic_get_section_ease_out: { epicSchema: S_epic_get_section_ease_out, ...bp(
    "read",
  ...
  epic_get_section_post_roll_frames: { epicSchema: S_epic_get_section_post_roll_frames, ...bp(
    "read",
  ...
  epic_get_section_pre_roll_frames: { epicSchema: S_epic_get_section_pre_roll_frames, ...bp(
    "read",
  ...
  epic_get_section_properties: { epicSchema: S_epic_get_section_properties, ...bp(
    "read",
  ...
  epic_get_section_range: { epicSchema: S_epic_get_section_range, ...bp(
    "read",
  ...
  epic_get_section_to_key: { epicSchema: S_epic_get_section_to_key, ...bp(
    "read",
  ...
  epic_get_sections: { epicSchema: S_epic_get_sections, ...bp(
    "read",
  ...
  epic_get_sections_for_nodes: { epicSchema: S_epic_get_sections_for_nodes, ...bp(
    "read",
  ...
  epic_get_selected_bindings: { epicSchema: S_epic_get_selected_bindings, ...bp(
    "read",
  ...
  epic_get_selected_channels: { epicSchema: S_epic_get_selected_channels, ...bp(
    "read",
  ...
  epic_get_selected_controls: { epicSchema: S_epic_get_selected_controls, ...bp(
    "read",
  ...
  epic_get_selected_folders: { epicSchema: S_epic_get_selected_folders, ...bp(
    "read",
  ...
  epic_get_selected_key_channels: { epicSchema: S_epic_get_selected_key_channels, ...bp(
    "read",
  ...
  epic_get_selected_sections: { epicSchema: S_epic_get_selected_sections, ...bp(
    "read",
  ...
  epic_get_selected_tracks: { epicSchema: S_epic_get_selected_tracks, ...bp(
    "read",
  ...
  epic_get_selection_range: { epicSchema: S_epic_get_selection_range, ...bp(
    "read",
  ...
  epic_get_sequence_lock_state: { epicSchema: S_epic_get_sequence_lock_state, ...bp(
    "read",
  ...
  epic_get_skeleton: { epicSchema: S_epic_get_skeleton, ...bp(
    "read",
  ...
  epic_get_socket_bone: { epicSchema: S_epic_get_socket_bone, ...bp(
    "read",
  ...
  epic_get_socket_names: { epicSchema: S_epic_get_socket_names, ...bp(
    "read",
  ...
  epic_get_socket_transform: { epicSchema: S_epic_get_socket_transform, ...bp(
    "read",
  ...
  epic_get_soloed_nodes: { epicSchema: S_epic_get_soloed_nodes, ...bp(
    "read",
  ...
  epic_get_sub_sequence_hierarchy: { epicSchema: S_epic_get_sub_sequence_hierarchy, ...bp(
    "read",
  ...
  epic_get_tick_resolution: { epicSchema: S_epic_get_tick_resolution, ...bp(
    "read",
  ...
  epic_get_track_condition: { epicSchema: S_epic_get_track_condition, ...bp(
    "read",
  ...
  epic_get_track_display_name: { epicSchema: S_epic_get_track_display_name, ...bp(
    "read",
  ...
  epic_get_track_filter_names: { epicSchema: S_epic_get_track_filter_names, ...bp(
    "read",
  ...
  epic_get_track_row_condition: { epicSchema: S_epic_get_track_row_condition, ...bp(
    "read",
  ...
  epic_get_tracks_on_binding: { epicSchema: S_epic_get_tracks_on_binding, ...bp(
    "read",
  ...
  epic_get_tracks_on_sequence: { epicSchema: S_epic_get_tracks_on_sequence, ...bp(
    "read",
  ...
  epic_get_transform: { epicSchema: S_epic_get_transform, ...bp(
    "read",
  ...
  epic_get_variable: { epicSchema: S_epic_get_variable, ...bp(
    "read",
  ...
  epic_get_vector2d: { epicSchema: S_epic_get_vector2d, ...bp(
    "read",
  ...
  epic_get_view_range: { epicSchema: S_epic_get_view_range, ...bp(
    "read",
  ...
  epic_get_work_range: { epicSchema: S_epic_get_work_range, ...bp(
    "read",
  ...
  epic_get_world_transform: { epicSchema: S_epic_get_world_transform, ...bp(
    "read",
  ...
  epic_has_section_end_frame: { epicSchema: S_epic_has_section_end_frame, ...bp(
    "read",
  ...
  epic_has_section_start_frame: { epicSchema: S_epic_has_section_start_frame, ...bp(
    "read",
  ...
  epic_hide_all_controls: { epicSchema: S_epic_hide_all_controls, ...bp(
    "mutate",
  ...
  epic_import_bones_from_asset: { epicSchema: S_epic_import_bones_from_asset, ...bp(
    "mutate",
  ...
  epic_import_fbx: { epicSchema: S_epic_import_fbx, ...bp(
    "mutate",
  ...
  epic_import_fbx_to_rig: { epicSchema: S_epic_import_fbx_to_rig, ...bp(
    "mutate",
  ...
  epic_is_camera_cut_locked: { epicSchema: S_epic_is_camera_cut_locked, ...bp(
    "read",
  ...
  epic_is_curve_editor_open: { epicSchema: S_epic_is_curve_editor_open, ...bp(
    "read",
  ...
  epic_is_curve_shown: { epicSchema: S_epic_is_curve_shown, ...bp(
    "read",
  ...
  epic_is_fk_control_rig: { epicSchema: S_epic_is_fk_control_rig, ...bp(
    "read",
  ...
  epic_is_layered_control_rig: { epicSchema: S_epic_is_layered_control_rig, ...bp(
    "read",
  ...
  epic_is_node_expanded: { epicSchema: S_epic_is_node_expanded, ...bp(
    "read",
  ...
  epic_is_playback_range_locked: { epicSchema: S_epic_is_playback_range_locked, ...bp(
    "read",
  ...
  epic_is_playing: { epicSchema: S_epic_is_playing, ...bp(
    "read",
  ...
  epic_is_sequence_locked: { epicSchema: S_epic_is_sequence_locked, ...bp(
    "read",
  ...
  epic_is_track_filter_active: { epicSchema: S_epic_is_track_filter_active, ...bp(
    "read",
  ...
  epic_key_controls: { epicSchema: S_epic_key_controls, ...bp(
    "mutate",
  ...
  epic_key_controls_at_frames: { epicSchema: S_epic_key_controls_at_frames, ...bp(
    "mutate",
  ...
  epic_link_anim_sequence: { epicSchema: S_epic_link_anim_sequence, ...bp(
    "mutate",
  ...
  epic_list_graphs: { epicSchema: S_epic_list_graphs, ...bp(
    "read",
  ...
  epic_list_pins: { epicSchema: S_epic_list_pins, ...bp(
    "read",
  ...
  epic_load_anim_into_rig: { epicSchema: S_epic_load_anim_into_rig, ...bp(
    "mutate",
  ...
  epic_merge_anim_layers: { epicSchema: S_epic_merge_anim_layers, ...bp(
    "mutate",
  ...
  epic_mirror_selected_controls: { epicSchema: S_epic_mirror_selected_controls, ...bp(
    "mutate",
  ...
  epic_move_space: { epicSchema: S_epic_move_space, ...bp(
    "mutate",
  ...
  epic_open_curve_editor: { epicSchema: S_epic_open_curve_editor, ...bp(
    "mutate",
  ...
  epic_open_sequence: { epicSchema: S_epic_open_sequence, ...bp(
    "mutate",
  ...
  epic_paste_bindings: { epicSchema: S_epic_paste_bindings, ...bp(
    "mutate",
  ...
  epic_paste_folders: { epicSchema: S_epic_paste_folders, ...bp(
    "mutate",
  ...
  epic_paste_sections: { epicSchema: S_epic_paste_sections, ...bp(
    "mutate",
  ...
  epic_paste_tracks: { epicSchema: S_epic_paste_tracks, ...bp(
    "mutate",
  ...
  epic_pause: { epicSchema: S_epic_pause, ...bp(
    "mutate",
  ...
  epic_play: { epicSchema: S_epic_play, ...bp(
    "mutate",
  ...
  epic_play_to: { epicSchema: S_epic_play_to, ...bp(
    "mutate",
  ...
  epic_rebind_component: { epicSchema: S_epic_rebind_component, ...bp(
    "mutate",
  ...
  epic_refresh_sequence: { epicSchema: S_epic_refresh_sequence, ...bp(
    "mutate",
  ...
  epic_remove_actors_from_binding: { epicSchema: S_epic_remove_actors_from_binding, ...bp(
    "mutate",
  ...
  epic_remove_all_bindings: { epicSchema: S_epic_remove_all_bindings, ...bp(
    "mutate",
  ...
  epic_remove_binding: { epicSchema: S_epic_remove_binding, ...bp(
    "mutate",
  ...
  epic_remove_binding_tag: { epicSchema: S_epic_remove_binding_tag, ...bp(
    "mutate",
  ...
  epic_remove_invalid_bindings: { epicSchema: S_epic_remove_invalid_bindings, ...bp(
    "mutate",
  ...
  epic_remove_key_at_frame: { epicSchema: S_epic_remove_key_at_frame, ...bp(
    "mutate",
  ...
  epic_remove_root_folder: { epicSchema: S_epic_remove_root_folder, ...bp(
    "mutate",
  ...
  epic_remove_section: { epicSchema: S_epic_remove_section, ...bp(
    "mutate",
  ...
  epic_remove_socket: { epicSchema: S_epic_remove_socket, ...bp(
    "mutate",
  ...
  epic_remove_track: { epicSchema: S_epic_remove_track, ...bp(
    "mutate",
  ...
  epic_remove_track_from_sequence: { epicSchema: S_epic_remove_track_from_sequence, ...bp(
    "mutate",
  ...
  epic_rename_socket: { epicSchema: S_epic_rename_socket, ...bp(
    "mutate",
  ...
  epic_reorder_anim_layers: { epicSchema: S_epic_reorder_anim_layers, ...bp(
    "mutate",
  ...
  epic_replace_binding_with_actors: { epicSchema: S_epic_replace_binding_with_actors, ...bp(
    "mutate",
  ...
  epic_save_default_spawnable_state: { epicSchema: S_epic_save_default_spawnable_state, ...bp(
    "mutate",
  ...
  epic_select_bindings: { epicSchema: S_epic_select_bindings, ...bp(
    "mutate",
  ...
  epic_select_channels: { epicSchema: S_epic_select_channels, ...bp(
    "mutate",
  ...
  epic_select_control: { epicSchema: S_epic_select_control, ...bp(
    "mutate",
  ...
  epic_select_folders: { epicSchema: S_epic_select_folders, ...bp(
    "mutate",
  ...
  epic_select_mirrored_controls: { epicSchema: S_epic_select_mirrored_controls, ...bp(
    "mutate",
  ...
  epic_select_sections: { epicSchema: S_epic_select_sections, ...bp(
    "mutate",
  ...
  epic_select_tracks: { epicSchema: S_epic_select_tracks, ...bp(
    "mutate",
  ...
  epic_set_anim_mode_gizmo_scale: { epicSchema: S_epic_set_anim_mode_gizmo_scale, ...bp(
    "mutate",
  ...
  epic_set_anim_mode_hide_manips: { epicSchema: S_epic_set_anim_mode_hide_manips, ...bp(
    "mutate",
  ...
  epic_set_anim_mode_hierarchy: { epicSchema: S_epic_set_anim_mode_hierarchy, ...bp(
    "mutate",
  ...
  epic_set_anim_mode_local_spaces: { epicSchema: S_epic_set_anim_mode_local_spaces, ...bp(
    "mutate",
  ...
  epic_set_anim_mode_nulls: { epicSchema: S_epic_set_anim_mode_nulls, ...bp(
    "mutate",
  ...
  epic_set_anim_mode_only_rig_sel: { epicSchema: S_epic_set_anim_mode_only_rig_sel, ...bp(
    "mutate",
  ...
  epic_set_binding_name: { epicSchema: S_epic_set_binding_name, ...bp(
    "mutate",
  ...
  epic_set_bool: { epicSchema: S_epic_set_bool, ...bp(
    "mutate",
  ...
  epic_set_byte_track_enum: { epicSchema: S_epic_set_byte_track_enum, ...bp(
    "mutate",
  ...
  epic_set_camera_cut_binding: { epicSchema: S_epic_set_camera_cut_binding, ...bp(
    "mutate",
  ...
  epic_set_camera_lock: { epicSchema: S_epic_set_camera_lock, ...bp(
    "mutate",
  ...
  epic_set_clock_source: { epicSchema: S_epic_set_clock_source, ...bp(
    "mutate",
  ...
  epic_set_controls_mask: { epicSchema: S_epic_set_controls_mask, ...bp(
    "mutate",
  ...
  epic_set_default_value: { epicSchema: S_epic_set_default_value, ...bp(
    "mutate",
  ...
  epic_set_display_rate: { epicSchema: S_epic_set_display_rate, ...bp(
    "mutate",
  ...
  epic_set_euler_transform: { epicSchema: S_epic_set_euler_transform, ...bp(
    "mutate",
  ...
  epic_set_evaluation_type: { epicSchema: S_epic_set_evaluation_type, ...bp(
    "mutate",
  ...
  epic_set_float: { epicSchema: S_epic_set_float, ...bp(
    "mutate",
  ...
  epic_set_global_transform: { epicSchema: S_epic_set_global_transform, ...bp(
    "mutate",
  ...
  epic_set_int: { epicSchema: S_epic_set_int, ...bp(
    "mutate",
  ...
  epic_set_layered_mode: { epicSchema: S_epic_set_layered_mode, ...bp(
    "mutate",
  ...
  epic_set_local_transform: { epicSchema: S_epic_set_local_transform, ...bp(
    "mutate",
  ...
  epic_set_loop_mode: { epicSchema: S_epic_set_loop_mode, ...bp(
    "mutate",
  ...
  epic_set_node_deactivated: { epicSchema: S_epic_set_node_deactivated, ...bp(
    "mutate",
  ...
  epic_set_node_expanded: { epicSchema: S_epic_set_node_expanded, ...bp(
    "mutate",
  ...
  epic_set_node_locked: { epicSchema: S_epic_set_node_locked, ...bp(
    "mutate",
  ...
  epic_set_node_muted: { epicSchema: S_epic_set_node_muted, ...bp(
    "mutate",
  ...
  epic_set_node_pinned: { epicSchema: S_epic_set_node_pinned, ...bp(
    "mutate",
  ...
  epic_set_node_position: { epicSchema: S_epic_set_node_position, ...bp(
    "mutate",
  ...
  epic_set_node_solo: { epicSchema: S_epic_set_node_solo, ...bp(
    "mutate",
  ...
  epic_set_outliner_selection: { epicSchema: S_epic_set_outliner_selection, ...bp(
    "mutate",
  ...
  epic_set_pin_value: { epicSchema: S_epic_set_pin_value, ...bp(
    "mutate",
  ...
  epic_set_playback_range: { epicSchema: S_epic_set_playback_range, ...bp(
    "mutate",
  ...
  epic_set_playback_range_locked: { epicSchema: S_epic_set_playback_range_locked, ...bp(
    "mutate",
  ...
  epic_set_playback_speed: { epicSchema: S_epic_set_playback_speed, ...bp(
    "mutate",
  ...
  epic_set_playhead_frame: { epicSchema: S_epic_set_playhead_frame, ...bp(
    "mutate",
  ...
  epic_set_position: { epicSchema: S_epic_set_position, ...bp(
    "mutate",
  ...
  epic_set_priority_order: { epicSchema: S_epic_set_priority_order, ...bp(
    "mutate",
  ...
  epic_set_property_name_and_path: { epicSchema: S_epic_set_property_name_and_path, ...bp(
    "mutate",
  ...
  epic_set_rotator: { epicSchema: S_epic_set_rotator, ...bp(
    "mutate",
  ...
  epic_set_scale: { epicSchema: S_epic_set_scale, ...bp(
    "mutate",
  ...
  epic_set_section_animation: { epicSchema: S_epic_set_section_animation, ...bp(
    "mutate",
  ...
  epic_set_section_blend_type: { epicSchema: S_epic_set_section_blend_type, ...bp(
    "mutate",
  ...
  epic_set_section_completion_mode: { epicSchema: S_epic_set_section_completion_mode, ...bp(
    "mutate",
  ...
  epic_set_section_condition: { epicSchema: S_epic_set_section_condition, ...bp(
    "mutate",
  ...
  epic_set_section_ease_in: { epicSchema: S_epic_set_section_ease_in, ...bp(
    "mutate",
  ...
  epic_set_section_ease_out: { epicSchema: S_epic_set_section_ease_out, ...bp(
    "mutate",
  ...
  epic_set_section_end_bounded: { epicSchema: S_epic_set_section_end_bounded, ...bp(
    "mutate",
  ...
  epic_set_section_post_roll_frames: { epicSchema: S_epic_set_section_post_roll_frames, ...bp(
    "mutate",
  ...
  epic_set_section_pre_roll_frames: { epicSchema: S_epic_set_section_pre_roll_frames, ...bp(
    "mutate",
  ...
  epic_set_section_range: { epicSchema: S_epic_set_section_range, ...bp(
    "mutate",
  ...
  epic_set_section_start_bounded: { epicSchema: S_epic_set_section_start_bounded, ...bp(
    "mutate",
  ...
  epic_set_selection_range: { epicSchema: S_epic_set_selection_range, ...bp(
    "mutate",
  ...
  epic_set_sequence_locked: { epicSchema: S_epic_set_sequence_locked, ...bp(
    "mutate",
  ...
  epic_set_socket_transform: { epicSchema: S_epic_set_socket_transform, ...bp(
    "mutate",
  ...
  epic_set_space: { epicSchema: S_epic_set_space, ...bp(
    "mutate",
  ...
  epic_set_tick_resolution: { epicSchema: S_epic_set_tick_resolution, ...bp(
    "mutate",
  ...
  epic_set_track_condition: { epicSchema: S_epic_set_track_condition, ...bp(
    "mutate",
  ...
  epic_set_track_display_name: { epicSchema: S_epic_set_track_display_name, ...bp(
    "mutate",
  ...
  epic_set_track_filter_active: { epicSchema: S_epic_set_track_filter_active, ...bp(
    "mutate",
  ...
  epic_set_track_row_condition: { epicSchema: S_epic_set_track_row_condition, ...bp(
    "mutate",
  ...
  epic_set_transform: { epicSchema: S_epic_set_transform, ...bp(
    "mutate",
  ...
  epic_set_vector2d: { epicSchema: S_epic_set_vector2d, ...bp(
    "mutate",
  ...
  epic_set_view_range: { epicSchema: S_epic_set_view_range, ...bp(
    "mutate",
  ...
  epic_set_work_range: { epicSchema: S_epic_set_work_range, ...bp(
    "mutate",
  ...
  epic_set_world_transform: { epicSchema: S_epic_set_world_transform, ...bp(
    "mutate",
  ...
  epic_show_all_controls: { epicSchema: S_epic_show_all_controls, ...bp(
    "mutate",
  ...
  epic_show_curve: { epicSchema: S_epic_show_curve, ...bp(
    "mutate",
  ...
  epic_snap_control_rig: { epicSchema: S_epic_snap_control_rig, ...bp(
    "mutate",
  ...
  epic_tag_binding: { epicSchema: S_epic_tag_binding, ...bp(
    "mutate",
  ...
  epic_tween_control_rig: { epicSchema: S_epic_tween_control_rig, ...bp(
    "mutate",
  ...
  epic_untag_binding: { epicSchema: S_epic_untag_binding, ...bp(
    "mutate",
  ...
  epic_zero_transforms: { epicSchema: S_epic_zero_transforms, ...bp(
    "mutate",
