...
export const actions: Record<string, ActionSpec> = {
  epic_add_plugin_dependency: { epicSchema: S_epic_add_plugin_dependency, ...bp(
    "mutate",
  ...
  epic_create_plugin: { epicSchema: S_epic_create_plugin, ...bp(
    "mutate",
  ...
  epic_get_game_feature_state: { epicSchema: S_epic_get_game_feature_state, ...bp(
    "read",
  ...
  epic_get_plugin_dependencies: { epicSchema: S_epic_get_plugin_dependencies, ...bp(
    "read",
  ...
  epic_get_plugin_dependents: { epicSchema: S_epic_get_plugin_dependents, ...bp(
    "read",
  ...
  epic_get_plugin_descriptor: { epicSchema: S_epic_get_plugin_descriptor, ...bp(
    "read",
  ...
  epic_get_plugin_for_asset: { epicSchema: S_epic_get_plugin_for_asset, ...bp(
    "read",
  ...
  epic_get_plugin_info: { epicSchema: S_epic_get_plugin_info, ...bp(
    "read",
  ...
  epic_get_plugin_template_descriptions: { epicSchema: S_epic_get_plugin_template_descriptions, ...bp(
    "read",
  ...
  epic_is_enabled: { epicSchema: S_epic_is_enabled, ...bp(
    "read",
  ...
  epic_is_game_feature_active: { epicSchema: S_epic_is_game_feature_active, ...bp(
    "read",
  ...
  epic_is_game_feature_plugin: { epicSchema: S_epic_is_game_feature_plugin, ...bp(
    "read",
  ...
  epic_is_plugin_creation_allowed: { epicSchema: S_epic_is_plugin_creation_allowed, ...bp(
    "read",
  ...
  epic_is_plugin_modification_allowed: { epicSchema: S_epic_is_plugin_modification_allowed, ...bp(
    "read",
  ...
  epic_list_discovered_game_feature_plugins: { epicSchema: S_epic_list_discovered_game_feature_plugins, ...bp(
    "read",
  ...
  epic_list_discovered_plugins: { epicSchema: S_epic_list_discovered_plugins, ...bp(
    "read",
  ...
  epic_list_enabled_game_feature_plugins: { epicSchema: S_epic_list_enabled_game_feature_plugins, ...bp(
    "read",
  ...
  epic_list_enabled_plugins: { epicSchema: S_epic_list_enabled_plugins, ...bp(
    "read",
  ...
  epic_remove_plugin_dependency: { epicSchema: S_epic_remove_plugin_dependency, ...bp(
    "mutate",
  ...
  epic_request_activate_game_feature: { epicSchema: S_epic_request_activate_game_feature, ...bp(
    "mutate",
  ...
  epic_request_deactivate_game_feature: { epicSchema: S_epic_request_deactivate_game_feature, ...bp(
    "mutate",
  ...
  epic_set_plugin_enabled: { epicSchema: S_epic_set_plugin_enabled, ...bp(
    "mutate",
  ...
  epic_update_plugin_descriptor: { epicSchema: S_epic_update_plugin_descriptor, ...bp(
    "mutate",
  ...
  epic_validate_new_plugin_name_and_location: { epicSchema: S_epic_validate_new_plugin_name_and_location, ...bp(
    "read",
