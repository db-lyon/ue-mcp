...
export const actions: Record<string, ActionSpec> = {
  ...
  epic_add_subgraph_node: { epicSchema: S_epic_add_subgraph_node, ...bp(
    "mutate",
  ...
  epic_draw_spline: { epicSchema: S_epic_draw_spline, ...bp(
    "mutate",
  ...
  epic_execute_graph_instance: { epicSchema: S_epic_execute_graph_instance, ...bp(
    "mutate",
  ...
  epic_get_graph_description: { epicSchema: S_epic_get_graph_description, ...bp(
    "read",
  ...
  epic_get_graph_instance_params: { epicSchema: S_epic_get_graph_instance_params, ...bp(
    "read",
  ...
  epic_get_graph_schema: { epicSchema: S_epic_get_graph_schema, ...bp(
    "read",
  ...
  epic_get_native_node_schema: { epicSchema: S_epic_get_native_node_schema, ...bp(
    "read",
  ...
  epic_get_node_data_view: { epicSchema: S_epic_get_node_data_view, ...bp(
    "read",
  ...
  epic_list_available_subgraphs: { epicSchema: S_epic_list_available_subgraphs, ...bp(
    "read",
  ...
  epic_list_graph_instances: { epicSchema: S_epic_list_graph_instances, ...bp(
    "read",
  ...
  epic_list_native_nodes: { epicSchema: S_epic_list_native_nodes, ...bp(
    "read",
  ...
  epic_remove_graph_params: { epicSchema: S_epic_remove_graph_params, ...bp(
    "mutate",
  ...
  epic_reset_graph_instance_params: { epicSchema: S_epic_reset_graph_instance_params, ...bp(
    "mutate",
  ...
  epic_run_pcginstant_graph: { epicSchema: S_epic_run_pcginstant_graph, ...bp(
    "mutate",
  ...
  epic_set_graph_description: { epicSchema: S_epic_set_graph_description, ...bp(
    "mutate",
  ...
  epic_set_graph_instance_params: { epicSchema: S_epic_set_graph_instance_params, ...bp(
    "mutate",
  ...
  epic_set_graph_params: { epicSchema: S_epic_set_graph_params, ...bp(
    "mutate",
  ...
  epic_set_node_comment: { epicSchema: S_epic_set_node_comment, ...bp(
    "mutate",
  ...
  epic_spawn_graph_instance: { epicSchema: S_epic_spawn_graph_instance, ...bp(
    "mutate",
  ...
  epic_update_comment_box: { epicSchema: S_epic_update_comment_box, ...bp(
    "mutate",
