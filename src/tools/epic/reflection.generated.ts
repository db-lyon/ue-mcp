...
export const actions: Record<string, ActionSpec> = {
  epic_get_class: { epicSchema: S_epic_get_class, ...bp(
    "read",
  ...
  epic_get_properties: { epicSchema: S_epic_get_properties, ...bp(
    "read",
  ...
  epic_list_properties: { epicSchema: S_epic_list_properties, ...bp(
    "read",
  ...
  epic_reset_properties: { epicSchema: S_epic_reset_properties, ...bp(
    "mutate",
  ...
  epic_search_subclasses: { epicSchema: S_epic_search_subclasses, ...bp(
    "read",
  ...
  epic_set_properties: { epicSchema: S_epic_set_properties, ...bp(
    "mutate",
