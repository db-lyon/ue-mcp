...
export const actions: Record<string, ActionSpec> = {
  epic_add_component_bound_event: { epicSchema: S_epic_add_component_bound_event, ...bp(
    "mutate",
  ...
  epic_add_event: { epicSchema: S_epic_add_event, ...bp(
    "mutate",
  ...
  epic_add_event_dispatcher: { epicSchema: S_epic_add_event_dispatcher, ...bp(
    "mutate",
  ...
  epic_add_function_graph: { epicSchema: S_epic_add_function_graph, ...bp(
    "mutate",
  ...
  epic_add_function_param: { epicSchema: S_epic_add_function_param, ...bp(
    "mutate",
  ...
  epic_add_node_pin: { epicSchema: S_epic_add_node_pin, ...bp(
    "mutate",
  ...
  epic_add_object_function_param: { epicSchema: S_epic_add_object_function_param, ...bp(
    "mutate",
  ...
  epic_add_object_variable: { epicSchema: S_epic_add_object_variable, ...bp(
    "mutate",
  ...
  epic_add_struct_function_param: { epicSchema: S_epic_add_struct_function_param, ...bp(
    "mutate",
  ...
  epic_add_struct_variable: { epicSchema: S_epic_add_struct_variable, ...bp(
    "mutate",
  ...
  epic_arrange_nodes: { epicSchema: S_epic_arrange_nodes, ...bp(
    "mutate",
  ...
  epic_break_pins: { epicSchema: S_epic_break_pins, ...bp(
    "mutate",
  ...
  epic_compile_blueprint: { epicSchema: S_epic_compile_blueprint, ...bp(
    "mutate",
  ...
  epic_find_node_categories: { epicSchema: S_epic_find_node_categories, ...bp(
    "read",
  ...
  epic_find_node_types: { epicSchema: S_epic_find_node_types, ...bp(
    "read",
  ...
  epic_find_nodes: { epicSchema: S_epic_find_nodes, ...bp(
    "read",
  ...
  epic_get_connected_subgraph: { epicSchema: S_epic_get_connected_subgraph, ...bp(
    "read",
  ...
  epic_get_create_event_function: { epicSchema: S_epic_get_create_event_function, ...bp(
    "read",
  ...
  epic_get_default_object: { epicSchema: S_epic_get_default_object, ...bp(
    "read",
  ...
  epic_get_graph_dsl_docs: { epicSchema: S_epic_get_graph_dsl_docs, ...bp(
    "read",
  ...
  epic_get_node_infos: { epicSchema: S_epic_get_node_infos, ...bp(
    "read",
  ...
  epic_get_node_type_pins: { epicSchema: S_epic_get_node_type_pins, ...bp(
    "read",
  ...
  epic_get_variable_category: { epicSchema: S_epic_get_variable_category, ...bp(
    "read",
  ...
  epic_get_variable_replication: { epicSchema: S_epic_get_variable_replication, ...bp(
    "read",
  ...
  epic_list_compatible_event_functions: { epicSchema: S_epic_list_compatible_event_functions, ...bp(
    "read",
  ...
  epic_list_component_events: { epicSchema: S_epic_list_component_events, ...bp(
    "read",
  ...
  epic_list_event_dispatchers: { epicSchema: S_epic_list_event_dispatchers, ...bp(
    "read",
  ...
  epic_list_events: { epicSchema: S_epic_list_events, ...bp(
    "read",
  ...
  epic_list_functions: { epicSchema: S_epic_list_functions, ...bp(
    "read",
  ...
  epic_read_graph_dsl: { epicSchema: S_epic_read_graph_dsl, ...bp(
    "read",
  ...
  epic_remove_function_graph: { epicSchema: S_epic_remove_function_graph, ...bp(
    "mutate",
  ...
  epic_remove_function_param: { epicSchema: S_epic_remove_function_param, ...bp(
    "mutate",
  ...
  epic_remove_node_pin: { epicSchema: S_epic_remove_node_pin, ...bp(
    "mutate",
  ...
  epic_retarget_node_class: { epicSchema: S_epic_retarget_node_class, ...bp(
    "mutate",
  ...
  epic_set_create_event_function: { epicSchema: S_epic_set_create_event_function, ...bp(
    "mutate",
  ...
  epic_set_parent: { epicSchema: S_epic_set_parent, ...bp(
    "mutate",
  ...
  epic_set_variable_category: { epicSchema: S_epic_set_variable_category, ...bp(
    "mutate",
  ...
  epic_set_variable_instance_editable: { epicSchema: S_epic_set_variable_instance_editable, ...bp(
    "mutate",
  ...
  epic_set_variable_replication: { epicSchema: S_epic_set_variable_replication, ...bp(
    "mutate",
  ...
  epic_write_graph_dsl: { epicSchema: S_epic_write_graph_dsl, ...bp(
    "mutate",
