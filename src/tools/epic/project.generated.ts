...
export const actions: Record<string, ActionSpec> = {
  epic_discover_tests: { epicSchema: S_epic_discover_tests, ...bp(
    "mutate",
  ...
  epic_get_section_property_values: { epicSchema: S_epic_get_section_property_values, ...bp(
    "read",
  ...
  epic_get_section_schema: { epicSchema: S_epic_get_section_schema, ...bp(
    "read",
  ...
  epic_get_test_results: { epicSchema: S_epic_get_test_results, ...bp(
    "read",
  ...
  epic_get_test_status: { epicSchema: S_epic_get_test_status, ...bp(
    "read",
  ...
  epic_list_categories: { epicSchema: S_epic_list_categories, ...bp(
    "read",
  ...
  epic_list_containers: { epicSchema: S_epic_list_containers, ...bp(
    "read",
  ...
  epic_list_sections: { epicSchema: S_epic_list_sections, ...bp(
    "read",
  ...
  epic_list_tests: { epicSchema: S_epic_list_tests, ...bp(
    "read",
  ...
  epic_reset_section_to_defaults: { epicSchema: S_epic_reset_section_to_defaults, ...bp(
    "mutate",
  ...
  epic_run_tests: { epicSchema: S_epic_run_tests, ...bp(
    "mutate",
  ...
  epic_run_tests_by_filter: { epicSchema: S_epic_run_tests_by_filter, ...bp(
    "mutate",
  ...
  epic_save_section: { epicSchema: S_epic_save_section, ...bp(
    "mutate",
  ...
  epic_set_section_properties: { epicSchema: S_epic_set_section_properties, ...bp(
    "mutate",
  ...
  epic_stop_tests: { epicSchema: S_epic_stop_tests, ...bp(
    "mutate",
