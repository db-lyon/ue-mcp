...
export const actions: Record<string, ActionSpec> = {
  epic_get_all_nodes: { epicSchema: S_epic_get_all_nodes, ...bp(
    "read",
  ...
  epic_get_node_by_guid: { epicSchema: S_epic_get_node_by_guid, ...bp(
    "read",
  ...
  epic_get_node_connections: { epicSchema: S_epic_get_node_connections, ...bp(
    "read",
  ...
  epic_get_node_guids: { epicSchema: S_epic_get_node_guids, ...bp(
    "read",
  ...
  epic_get_sub_nodes: { epicSchema: S_epic_get_sub_nodes, ...bp(
    "read",
  ...
  epic_list_entry_points: { epicSchema: S_epic_list_entry_points, ...bp(
    "read",
  ...
  epic_list_speakers: { epicSchema: S_epic_list_speakers, ...bp(
    "read",
