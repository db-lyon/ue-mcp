...
export const actions: Record<string, ActionSpec> = {
  epic_add_expression: { epicSchema: S_epic_add_expression, ...bp(
    "mutate",
  ...
  epic_clear_parameters: { epicSchema: S_epic_clear_parameters, ...bp(
    "mutate",
  ...
  epic_connect_expressions: { epicSchema: S_epic_connect_expressions, ...bp(
    "mutate",
  ...
  epic_connect_to_output: { epicSchema: S_epic_connect_to_output, ...bp(
    "mutate",
  ...
  epic_create_function: { epicSchema: S_epic_create_function, ...bp(
    "mutate",
  ...
  epic_create_material: { epicSchema: S_epic_create_material, ...bp(
    "mutate",
  ...
  epic_create_parameter_collection: { epicSchema: S_epic_create_parameter_collection, ...bp(
    "mutate",
  ...
  epic_delete_expression: { epicSchema: S_epic_delete_expression, ...bp(
    "mutate",
  ...
  epic_delete_parameter_group: { epicSchema: S_epic_delete_parameter_group, ...bp(
    "mutate",
  ...
  epic_delete_unused_expressions: { epicSchema: S_epic_delete_unused_expressions, ...bp(
    "mutate",
  ...
  epic_disconnect_expressions: { epicSchema: S_epic_disconnect_expressions, ...bp(
    "mutate",
  ...
  epic_disconnect_from_output: { epicSchema: S_epic_disconnect_from_output, ...bp(
    "mutate",
  ...
  epic_get_expression_input_names: { epicSchema: S_epic_get_expression_input_names, ...bp(
    "read",
  ...
  epic_get_expression_inputs: { epicSchema: S_epic_get_expression_inputs, ...bp(
    "read",
  ...
  epic_get_expression_output_names: { epicSchema: S_epic_get_expression_output_names, ...bp(
    "read",
  ...
  epic_get_expressions: { epicSchema: S_epic_get_expressions, ...bp(
    "read",
  ...
  epic_get_property_input: { epicSchema: S_epic_get_property_input, ...bp(
    "read",
  ...
  epic_get_referencing_materials: { epicSchema: S_epic_get_referencing_materials, ...bp(
    "read",
  ...
  epic_get_scalar_parameter: { epicSchema: S_epic_get_scalar_parameter, ...bp(
    "read",
  ...
  epic_get_static_switch_parameter: { epicSchema: S_epic_get_static_switch_parameter, ...bp(
    "read",
  ...
  epic_get_texture_parameter: { epicSchema: S_epic_get_texture_parameter, ...bp(
    "read",
  ...
  epic_get_vector_parameter: { epicSchema: S_epic_get_vector_parameter, ...bp(
    "read",
  ...
  epic_layout_expressions: { epicSchema: S_epic_layout_expressions, ...bp(
    "mutate",
  ...
  epic_list_expression_classes: { epicSchema: S_epic_list_expression_classes, ...bp(
    "read",
  ...
  epic_list_parameter_groups: { epicSchema: S_epic_list_parameter_groups, ...bp(
    "read",
  ...
  epic_list_parameters: { epicSchema: S_epic_list_parameters, ...bp(
    "read",
  ...
  epic_recompile: { epicSchema: S_epic_recompile, ...bp(
    "mutate",
  ...
  epic_rename_parameter_group: { epicSchema: S_epic_rename_parameter_group, ...bp(
    "mutate",
  ...
  epic_set_parameter_override: { epicSchema: S_epic_set_parameter_override, ...bp(
    "mutate",
  ...
  epic_set_scalar_parameter: { epicSchema: S_epic_set_scalar_parameter, ...bp(
    "mutate",
  ...
  epic_set_static_switch_parameter: { epicSchema: S_epic_set_static_switch_parameter, ...bp(
    "mutate",
  ...
  epic_set_texture_parameter: { epicSchema: S_epic_set_texture_parameter, ...bp(
    "mutate",
  ...
  epic_set_vector_parameter: { epicSchema: S_epic_set_vector_parameter, ...bp(
    "mutate",
