...
export const actions: Record<string, ActionSpec> = {
  epic_create_skill: { epicSchema: S_epic_create_skill, ...bp(
    "mutate",
  ...
  epic_execute_tool_script: { epicSchema: S_epic_execute_tool_script, ...bp(
    "mutate",
  ...
  epic_get_execution_environment: { epicSchema: S_epic_get_execution_environment, ...bp(
    "read",
  ...
  epic_get_skills: { epicSchema: S_epic_get_skills, ...bp(
    "read",
  ...
  epic_list_skills: { epicSchema: S_epic_list_skills, ...bp(
    "read",
  ...
  epic_update_skill: { epicSchema: S_epic_update_skill, ...bp(
    "mutate",
