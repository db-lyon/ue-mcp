...
export const actions: Record<string, ActionSpec> = {
  epic_add_component: { epicSchema: S_epic_add_component, ...bp(
    "mutate",
  ...
  epic_add_cone: { epicSchema: S_epic_add_cone, ...bp(
    "mutate",
  ...
  epic_add_cube: { epicSchema: S_epic_add_cube, ...bp(
    "mutate",
  ...
  epic_add_cylinder: { epicSchema: S_epic_add_cylinder, ...bp(
    "mutate",
  ...
  epic_add_sphere: { epicSchema: S_epic_add_sphere, ...bp(
    "mutate",
  ...
  epic_add_to_scene_from_asset: { epicSchema: S_epic_add_to_scene_from_asset, ...bp(
    "mutate",
  ...
  epic_add_to_scene_from_class: { epicSchema: S_epic_add_to_scene_from_class, ...bp(
    "mutate",
  ...
  epic_can_edit: { epicSchema: S_epic_can_edit, ...bp(
    "read",
  ...
  epic_commit_level_instance: { epicSchema: S_epic_commit_level_instance, ...bp(
    "mutate",
  ...
  epic_create_level_instance: { epicSchema: S_epic_create_level_instance, ...bp(
    "mutate",
  ...
  epic_delete_folder: { epicSchema: S_epic_delete_folder, ...bp(
    "mutate",
  ...
  epic_edit_level_instance: { epicSchema: S_epic_edit_level_instance, ...bp(
    "mutate",
  ...
  epic_find_actors: { epicSchema: S_epic_find_actors, ...bp(
    "read",
  ...
  epic_get_actor_bounds: { epicSchema: S_epic_get_actor_bounds, ...bp(
    "read",
  ...
  epic_get_actor_transform: { epicSchema: S_epic_get_actor_transform, ...bp(
    "read",
  ...
  epic_get_actors_in_folder: { epicSchema: S_epic_get_actors_in_folder, ...bp(
    "read",
  ...
  epic_get_collision_channels: { epicSchema: S_epic_get_collision_channels, ...bp(
    "read",
  ...
  epic_get_component_actor: { epicSchema: S_epic_get_component_actor, ...bp(
    "read",
  ...
  epic_get_components: { epicSchema: S_epic_get_components, ...bp(
    "read",
  ...
  epic_get_current_level: { epicSchema: S_epic_get_current_level, ...bp(
    "read",
  ...
  epic_get_folders: { epicSchema: S_epic_get_folders, ...bp(
    "read",
  ...
  epic_get_label: { epicSchema: S_epic_get_label, ...bp(
    "read",
  ...
  epic_get_parent_component: { epicSchema: S_epic_get_parent_component, ...bp(
    "read",
  ...
  epic_get_root_component: { epicSchema: S_epic_get_root_component, ...bp(
    "read",
  ...
  epic_get_tags: { epicSchema: S_epic_get_tags, ...bp(
    "read",
  ...
  epic_has_tag: { epicSchema: S_epic_has_tag, ...bp(
    "read",
  ...
  epic_load_level: { epicSchema: S_epic_load_level, ...bp(
    "mutate",
  ...
  epic_look_at: { epicSchema: S_epic_look_at, ...bp(
    "mutate",
  ...
  epic_merge_actors: { epicSchema: S_epic_merge_actors, ...bp(
    "mutate",
  ...
  epic_remove_component: { epicSchema: S_epic_remove_component, ...bp(
    "mutate",
  ...
  epic_remove_from_scene: { epicSchema: S_epic_remove_from_scene, ...bp(
    "mutate",
  ...
  epic_rename_folder: { epicSchema: S_epic_rename_folder, ...bp(
    "mutate",
  ...
  epic_save_actor: { epicSchema: S_epic_save_actor, ...bp(
    "mutate",
  ...
  epic_set_actor_folder: { epicSchema: S_epic_set_actor_folder, ...bp(
    "mutate",
  ...
  epic_set_actor_transform: { epicSchema: S_epic_set_actor_transform, ...bp(
    "mutate",
  ...
  epic_set_label: { epicSchema: S_epic_set_label, ...bp(
    "mutate",
  ...
  epic_set_parent_component: { epicSchema: S_epic_set_parent_component, ...bp(
    "mutate",
  ...
  epic_trace_world: { epicSchema: S_epic_trace_world, ...bp(
    "mutate",
