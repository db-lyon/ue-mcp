...
export const editorTool: ToolDef = categoryTool(
  "editor",
  "Editor commands, Python execution, PIE, undo/redo, hot reload, viewport, performance, sequencer.",
  {
...
- play_sequence: Play/stop/pause. Params: assetPath, sequenceAction ('play'|'stop'|'pause')`,
  {
