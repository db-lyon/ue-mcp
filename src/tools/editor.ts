...
export const editorTool: ToolDef = categoryTool(
  ...
  "Editor commands, Python execution, PIE, undo/redo, hot reload, viewport, performance, sequencer, build pipeline, logs, editor control.",
  {
    ...
    invoke_function: bp("Call a BlueprintCallable / Exec UFUNCTION on a target actor. Params: actorLabel, functionName, args? (object), world? (editor|pie). Returns out/return params (#228/#229)", "invoke_function", (p) => ({ actorLabel: p.actorLabel, functionName: p.functionName, args: p.args, world: p.world })),
