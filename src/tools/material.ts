...
export const materialTool: ToolDef = categoryTool(
  ...
  "Materials: create, read, parameters, shading, textures, and graph authoring (expression nodes, connections).",
  {
    ...
    duplicate_tinted:  bp("Duplicate or reuse a material and multiply BaseColor by a tint. Params: sourcePath, destinationPath, color, save?", "duplicate_material_with_base_color_tint"),
