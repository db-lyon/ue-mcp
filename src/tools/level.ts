...
export const levelTool: ToolDef = categoryTool(
  ...
  undefined,  // actionDocs auto-generated from descriptions
  {
    ...
    worldSpace: z.boolean().optional().describe("add_hismc_instances: treat transforms as world-space (default true) (#434)"),
